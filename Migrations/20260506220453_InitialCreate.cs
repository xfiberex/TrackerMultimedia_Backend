        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkToken = table.Column<string>(type: "text", nullable: true),
                    PendingProviderKey = table.Column<string>(type: "text", nullable: true),
                    PendingEmail = table.Column<string>(type: "text", nullable: true),
                    PendingDisplayName = table.Column<string>(type: "text", nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalMediaKind = table.Column<int>(type: "integer", nullable: true),
                    ExternalStatusLabel = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OAuthStates_StateValue",
                table: "OAuthStates",
                column: "StateValue",
                unique: true);
