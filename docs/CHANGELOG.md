...
- **Al elegir el color de una categoría nueva ya no se corta nada.** El desplegable de colores se salía del cuadro: aparecía una barra de desplazamiento y la fila del color personalizado quedaba recortada, aun habiendo sitio de sobra en la pantalla. Ahora el cuadro crece con él (T5-12).
...
- **Cambiar la contraseña ahora cierra la sesión en tus demás dispositivos.** Antes no cerraba ninguna: quien cambiaba la contraseña por sospechar que le habían robado la sesión seguía con esa sesión ajena abierta y funcionando durante los siete días siguientes, que es justo lo que se quería cortar. Ahora, al cambiarla, cualquier otro sitio donde estuvieras dentro —otro navegador, el móvil, un ordenador que dejaste encendido— vuelve a pedir tus datos. **El dispositivo desde el que la cambias no te echa**: sigues donde estabas, sin volver a entrar (T6-01).
